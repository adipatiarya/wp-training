# wp-training
## Bagian 1: Welcome
    1. 2024 Roadmap & Intro!
    2. Welcome to the Course!
## Bagian 2: Getting Started
    3. What is a Dev Environment? (You First Installation)
    4. If You're Unable to Install By FlyWheel
    5. About the Recent Big Changes To Wordpress
    6. Fitsr Taste PHP
## Bagian 3: First Coding Steps: PHP
    7. A Note About URLs/My Address Bar
...
33 Bagian 10: Cleaner Code(Less Duplication)
    ...
    48. Quick fix for page banner function
